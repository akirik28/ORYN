...
- **Migration `0112_advisor_conversation_retention.sql`** (renumbered twice — 0109, then 0110, then 0112 at merge when the integrator started assigning numbers; originally moved from 0109 —

...
--
-- academic_tier = 'applied_sciences' for all 192 (unambiguous -- Hochschulkompass's
-- own Hochschultyp=Fachhochschulen/HAW filter). academic_tier_local_name =
-- 'Fachhochschule' for all 192 -- the German legal/registry term, the same word
-- Austria's batch also uses correctly, since it is the same institutional form.
--

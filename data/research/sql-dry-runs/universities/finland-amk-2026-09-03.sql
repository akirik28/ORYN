...
--
-- academic_tier = 'applied_sciences' for all 22 (unambiguous -- Vipunen's own AMK
-- listing). academic_tier_local_name = 'Ammattikorkeakoulu', the Finnish registry
-- term, the same for all 22.

 ...
 *
 * Carries its own card chrome inline (FIXED 2026-09-04) -- previously provided by
 ...
 *
 * No logo of its own (REMOVED 2026-09-04) -- app/parent/layout.tsx now renders one in a
 * shared header above every route under /parent, this page included; keeping a second one
 * here would have shown it twice.
 */

...
export const ACTIVITY_FIELDS: FieldConfig[] = [
  ...
  // fallback: the opportunity catalog is curated, not student-extendable.
  {
    ...
    scope: "opportunity",
    label: "Proxola program/opportunity this matches (optional)",
...
const FIELD_TEXT_TR: Record<string, string> = {
  ...
  "Proxola program/opportunity this matches (optional)": "Bununla eşleşen Proxola programı/fırsatı (opsiyonel)",
  "Recreational": "Amatör",
  "Regional": "Bölgesel",
  "Regular": "Normal",

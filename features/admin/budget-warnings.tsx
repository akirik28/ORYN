...
import { PER_STUDENT_MONTHLY_CEILING_USD, type UserSpend } from "./spend-data";
 ...
 * (BUDGET_WARNING_FRACTION in spend-data.ts) — the ceiling, not the lower target, since the
 * target is aspirational and the ceiling is where real overage risk starts.
 */
export async function BudgetWarningsCard({ users }: { users: UserSpend[] }) {

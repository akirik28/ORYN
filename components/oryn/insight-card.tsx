 ...
 * amber headline.
 *
 * This component never carries the warm recommendation ground. That surface belongs to
 * `NextMove`, which is where a statement heavy enough to earn it lives; the brief allows it
 * "selectively" and warns against it becoming dominant, so keeping it on one component
 * makes "at most one per screen" something you can actually check.
 */

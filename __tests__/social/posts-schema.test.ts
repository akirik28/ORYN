...
describe("migration numbering", () => {
  test("0058 is not duplicated, even though a later migration now exists", () => {
    ...
    // follows it, and 0060 (superseded-university-programs, 2026-08-22) follows that. Bump
    // the literal below when the next migration lands, the same way this one did — it is a

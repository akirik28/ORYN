...
const LOCALE_AWARE =
  /useTranslations|getTranslations|locale === "tr"|getLegalCopy|dimensionLabel|evidenceStateLabel|openToLabel|subjectLabel|requirementCategoryLabel|evidenceLinkableLabel|searchResultTypeLabel/;

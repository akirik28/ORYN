 ...
 * retryAdvisorMessage's update both now write `degraded`, and migration 0087
...
describe("sendAdvisorMessage — the assistant-message insert degrades instead of failing outright", () => {
  ...
  test("migration 0087 unapplied (insert rejects on degraded): retries without it, still saves the reply", async () => {
...
describe("retryAdvisorMessage — the assistant-message update degrades instead of failing outright", () => {
  ...
  test("migration 0087 unapplied (update rejects on degraded): retries without it, still saves the reply", async () => {
